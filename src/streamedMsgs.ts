...
function getControlTypeAsInt(type: any): number {
...
function getMessageTypeAsInt(type: string | number): number {
...
//treat as interface.  replace with OpenAPI Spec version
