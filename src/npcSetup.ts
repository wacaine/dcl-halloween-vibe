...
//import { closeCustomUI, openCustomUI } from './NPCs/customUi'//uncomment to use v1
...
const DUCKING_NPC_ANIMATIONS: NpcAnimationNameType = {
  HI: { name: "Armature|Take 001|BaseLayer", duration: 2, autoStart: undefined, portraitPath: "images/portraits/ducking/hi1.png" },
  IDLE: { name: "Armature|Take 001|BaseLayer", duration: 4, autoStart: undefined, portraitPath: "images/portraits/ducking/idle1.png" },
  TALK: { name: "Armature|Take 001|BaseLayer", duration: 2, autoStart: undefined, portraitPath: "images/portraits/ducking/talking1.png" },
  THINKING: { name: "Armature|Take 001|BaseLayer", duration: 2, autoStart: undefined, portraitPath: "images/portraits/ducking/interesting1.png" },
  LOADING: { name: "Armature|Take 001|BaseLayer", duration: 2, autoStart: undefined, portraitPath: "images/portraits/ducking/interesting1.png" },
  LAUGH: { name: "Armature|Take 001|BaseLayer", duration: 2, autoStart: undefined, portraitPath: "images/portraits/ducking/laughing1.png" },
  HAPPY: { name: "Armature|Take 001|BaseLayer", duration: 2, autoStart: undefined, portraitPath: "images/portraits/ducking/happy1.png" },
  SAD: { name: "Armature|Take 001|BaseLayer", duration: 2, autoStart: undefined, portraitPath: "images/portraits/ducking/sad1.png" },
  SURPRISE: { name: "Armature|Take 001|BaseLayer", duration: 2, autoStart: undefined, portraitPath: "images/portraits/ducking/surprise1.png" },
}
...
function createSimonas() {
  ...
  simonas = new RemoteNpc(
    { resourceName: "workspaces/genesis_city/characters/simone", id: "Ducking"  },
    {
      transformData: { position: Vector3.create(0, 0, 0), scale: Vector3.create(.25, .25, .25) },
      npcData: {
        type: npcLib.NPCType.CUSTOM,
        model: {
          src: 'models/Ducking.glb',
